...
// Map frontend platform values to backend enum values
const mapPlatformToBackend = (platform) => {
  const mapping = {
    instagram: 'meta',
    facebook: 'meta',
    twitter: 'google', // Map to google for now
    linkedin: 'linkedin',
    youtube: 'google',
    tiktok: 'meta',
  };
...
// Map frontend format values to backend enum values
const mapFormatToBackend = (format, platform) => {
  // Backend expects: square, landscape, portrait, story
  const mapping = {
    post: 'square',
    square: 'square',
    story: 'story',
